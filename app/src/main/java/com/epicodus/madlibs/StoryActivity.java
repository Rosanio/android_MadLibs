...
public class StoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent.getStringExtra("storyType").equals("Standard")) {
            ...
            mStoryTextView.setText(name + " woke up in a(n) " + place + "!!!!!!! 'Where the hell am I', wondered " + name + "!!!!!!!!! Suddenly, " + name + " entered a frenzied panic!!!!!!!!!!! 'I forgot to " + verb + " the " + animal + "', " + name + " said to themselves!!!!!!!!!!!!!! They " + adjective + " ran home to " + verb + " their " + animal + "!!!!!!!!!!!!!" + progress);
        }
